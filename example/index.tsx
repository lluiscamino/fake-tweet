...
const App = () => {
  ...
  const [text, setText] = useState(
    'Falcon 9 launches Starlink to orbit – the eighth launch and landing of this booster 🚀'
  );
  ...
  return (
    <div className="App">
      <a
        href="https://github.com/lluiscamino/fake-tweet"
        target="_blank"
      ...
      <footer>
        ...
        <span id="footer-links">
          ...
          <a
            href="https://www.npmjs.com/package/fake-tweet"
            title="View on NPM"
          >
            <img
              src={require('./images/npm-icon.png')}
              alt="NPM icon"
              className="footer-icon"
            />
          </a>
